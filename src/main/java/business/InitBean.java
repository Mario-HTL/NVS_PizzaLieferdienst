...
public class InitBean {
    ...
    public void init(){
        ...
        oFacade.create(new Order(dFacade.getDriverById(1), productList, "Musterstreet 8", 4020, false));
        oFacade.create(new Order(dFacade.getDriverById(1), productList, "Finished 8", 4020, true));
    }
}
